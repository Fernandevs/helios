    ...
    <div className="md:col-span-8 card-satellite p-stack-lg group overflow-hidden relative">
      <div className="flex justify-between items-start mb-24">
        <div>
          ...
          <h3 className="text-headline-md text-on-surface font-semibold">Nebula-Cloud Infrastructure</h3>
        </div>
      ...
      <div className="w-full h-64 bg-surface-container-lowest border border-outline-variant/30 overflow-hidden mb-stack-lg rounded relative">
        <Image
          alt="Nebula-Cloud Infrastructure"
      ...
      <p className="text-body-md text-on-surface-variant mb-stack-md">
        Redesigning the core backbone of a multi-region SaaS platform to achieve 99.999% availability under 2TB/s load.
      </p>
...
export function MediumProjectCard() {
  return (
    <div className="md:col-span-8 card-satellite p-stack-lg group flex flex-col justify-center">
      <div className="flex flex-col md:flex-row gap-gutter">
        ...
        <div className="md:w-2/3">
          <h3 className="text-headline-md text-on-surface mb-stack-sm font-semibold">ChronoDB Layer</h3>
          <p className="text-body-md text-on-surface-variant mb-stack-lg">
            A custom caching abstraction layer that reduced query latency by 45% across legacy PostgreSQL clusters.
          </p>
